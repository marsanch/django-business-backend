"""
Configuración de Django para el proyecto appointment_reminder.
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='appointment_reminder'),
...
# Fallback para SQLite en desarrollo
if DEBUG:
    DATABASES['default'] = {
...
REMINDER_ENABLED = config('REMINDER_ENABLED', default=True, cast=bool)
